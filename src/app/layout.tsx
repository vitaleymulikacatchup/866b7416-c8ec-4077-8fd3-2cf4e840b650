...
export const metadata: Metadata = {
  title: "GoldGym - Premium Fitness Center & Personal Training",
  description: "Transform your body at GoldGym with premium equipment, expert trainers, unlimited classes and flexible membership plans. Start your free trial today!",
  keywords: "gym, fitness center, personal training, group classes, workout, strength training, cardio, membership",
  metadataBase: new URL("https://goldgym.com"),
  alternates: {
    canonical: "https://goldgym.com"
  },
  openGraph: {
    title: "GoldGym - Premium Fitness Center & Personal Training",
    description: "Transform your body at GoldGym with premium equipment, expert trainers, unlimited classes and flexible membership plans. Start your free trial today!",
    ...
    images: [{
      ...
      alt: "GoldGym modern fitness facility"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "GoldGym - Premium Fitness Center & Personal Training",
    description: "Transform your body at GoldGym with premium equipment, expert trainers, unlimited classes and flexible membership plans.",
